        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/catalogos/categorias/agregar') }}">
                            @csrf
                            <div class="form-group mb-3">
                                <label for="nombre">Nombre:</label>
                                <input type="text" maxlength="50" name="nombre" id="nombre" placeholder="Ingrese nombre de la categoría" class="form-control" required autofocus>
                            </div>
                            <div class="form-group mb-3">
